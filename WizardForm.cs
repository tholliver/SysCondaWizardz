...
public class WizardForm : Form
{
    ...
    private void InitializeForm()
    {
        ...
        _headerPanel.Padding = new Padding(24, 18, 24, 16);
    ...
    private void RefreshNavigationState()
    {
        ...
        if (InvokeRequired)
        {
            BeginInvoke(RefreshNavigationState);
            return;
        }
        ...
        _btnNext.Text = _installStep.HasCompleted
            ? "Cerrar"
            : _installStep.IsRunning
                ? "Instalando..."
                : "✔ Finalizar";
    }
...
internal class StepsBar : Control
{
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        for (var i = 0; i < Names.Length; i++)
        {
            ...
            g.DrawString(Names[i], i == Active ? activeFont : idleFont, labelBrush, labelRect, sf);
            labelBrush.Dispose();
        }
    }
}
